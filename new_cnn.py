...
PHASE1_EPOCHS = 10     # first train just the final layer
PHASE2_EPOCHS = 25    # then fine-tune the whole model

LR_HEAD      = 1e-3   # learning rate for classifier head
LR_FULL      = 1e-4   # smaller LR when unfreezing everything
WEIGHT_DECAY = 1e-4
...
# Example run:
# export KWX_DATASET="dataset_name_here"
# python3 cnn_part2_no_part1.py
